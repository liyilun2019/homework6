...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        switch (note.getPriority()){
            case 0:
                dateText.setTextColor(dateText.getResources().getColor(R.color.pri0));
                break;
            case 1:
                dateText.setTextColor(dateText.getResources().getColor(R.color.pri1));
                break;
            case 2:
                dateText.setTextColor(dateText.getResources().getColor(R.color.pri2));
                break;
        }
