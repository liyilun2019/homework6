...
public class DebugActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileWriteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // endTODO 把一段文本写入某个存储区的文件中，再读出来，显示在 fileText 上
                File f1 = new File(getExternalCacheDir(),"text.txt");
                ...
                try {
                    ...
                    bufferedWriter.write(f1.getAbsolutePath()+"::liyilun");
                ...
                try{
                    ...
                    e.printStackTrace();
                    Log.d(TAG, "read file: "+e.getClass().getName()+" "+e.getMessage());
                }finally {
                    if(fileReader!=null){
                        try {
                            fileReader.close();
